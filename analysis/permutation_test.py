...
def blocked_sampled_test(
    ...
    """ observed_values should be a matrix of the form
        number of blocks x (number of agents x number of features) 
        with entries representing values of features """
    """ unit_assignments should be a matrix of the form
        number of blocks x number of agents
        with entries enumerating treatment type
        0 for first treatment, etc. """
    """ test_stat is a function for computing the test statistic 
        test_stat should take observed_values and unit_assignments
        as parameters and return an integer """
